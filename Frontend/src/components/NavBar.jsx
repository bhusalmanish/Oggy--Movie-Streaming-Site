...
export default function NavBar() {
  return (
    <div>
  <Box sx={{ flexGrow: 1}}>
      <AppBar  position="static"  sx={{ height: '70px', color:'#F22'}}>
        <Toolbar>
          <IconButton
            size="large"
            edge="start"
            ...
            sx={{ mr: 2 }}
          > 
            <img  height = "80px" width="80px" src="./logo.png"alt="oggy"/>
          </IconButton>
